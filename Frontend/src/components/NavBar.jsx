...
import { IoMdArrowBack, IoMdSettings, IoMdNotifications , IoMdPersonAdd } from "react-icons/io";
    ...
    <nav className="sticky top-0 z-50 w-full bg-white shadow-lg">
      <div className="flex justify-between items-center h-16 md:h-20 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex items-center">
          <div className="w-14 h-14 md:w-16 md:h-16 overflow-hidden rounded-full border-2 border-indigo-500 shadow-md">
            <img
          ...
          <span className="ml-3 text-lg md:text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            ChatSphere
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-5">
          <button className="flex items-center gap-2 text-indigo-600 hover:text-indigo-800 border-1 border-indigo-200 cursor-pointer transition-colors px-3 py-2 rounded-lg hover:bg-indigo-50">
          ...
          <button
            ...
            className="ml-2 flex items-center gap-1 text-indigo-600 hover:text-indigo-800 transition-colors px-3 py-2 rounded-lg hover:bg-indigo-50"
          >
        ...
        <div className="flex flex-col h-full p-6">
          ...
          <div className="flex-1 py-8 flex flex-col">
            <div className="mb-auto space-y-4">
              <div className="flex items-center gap-4 p-4 rounded-lg hover:bg-indigo-50 cursor-pointer transition-all">
              ...
              <div className="flex items-center gap-4 p-4 rounded-lg hover:bg-indigo-50 cursor-pointer transition-all">
                <div className="bg-indigo-100 p-2 rounded-lg">
                  <IoMdPersonAdd className="w-6 h-6 text-indigo-600" />
                </div>
                <span className="font-medium text-gray-700">Friend Requests</span>
              </div>
            </div>
